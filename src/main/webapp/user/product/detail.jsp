                ...
                <div class="product_slider_img">
                    <div id="vertical">
                        <div data-thumb="<%=product.getImage()%>">
                            <img src="<%=product.getImage()%>" class="img-thumbnail" width="400px"/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-5 col-xl-4">
                <div class="s_product_text">
                    ...
                    <div class="card_area d-flex justify-content-between align-items-center">
                        ...
                        <a href="/cart/add?id=<%=product.getId()%>&qty=1" class="btn_3">Add to cart</a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="comment_list">
                            <div class="review_item">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="/user/content/img/product/single-product/review-1.png" alt="" />
                                    </div>
                            ...
                            <div class="review_item reply">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="/user/content/img/product/single-product/review-2.png" alt="" />
                                    </div>
                                    <div class="media-body">
                                        <h4>Blake Ruiz</h4>
                                        <h5>12th Feb, 2017 at 05:56 pm</h5>
                            ...
                            <div class="review_item">
                                <div class="media">
                                    <div class="d-flex">
                                        <img src="/user/content/img/product/single-product/review-3.png" alt="" />
                                    </div>
                                    <div class="media-body">
                                        <h4>Blake Ruiz</h4>
                                        <h5>12th Feb, 2017 at 05:56 pm</h5>
                    ...
                    <div class="col-lg-6">
                        <div class="review_box">
                            ...
                            <form class="row contact_form" action="https://technext.github.io/aranoz/contact_process.php" method="post" id="contactForm"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="review_box">
                            ...
                            <p>Outstanding</p>
                            <form class="row contact_form" action="https://technext.github.io/aranoz/contact_process.php" method="post" novalidate="novalidate">
                                <div class="col-md-12">
                                    <div class="form-group">
